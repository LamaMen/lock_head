...
if (window.location.href == "http://127.0.0.1:5000/tasks") { current_page = document.getElementById('a1'); }
else if (window.location.href == "http://127.0.0.1:5000/") { current_page = document.getElementById('a2'); }
